...
class task_user:
    ...
    def __init__(self, LeftMotorGo, RightMotorGo, dataValuesleft, timeValuesleft, dataValuesright, timeValuesright,
        ...
        #self._ser: stream = UART(2,115_200) #use this for bluetooth or serial, 3 is btooth and 2 is stlink
        ...
        self._dataValsArc : Queue = dataValsArc
        self._dataValsPsi : Queue = dataValsPsi
    ...
    def run(self):
        ...
        while True:
            ...
            if self._state == S0_INIT: # Init state (can be removed if unneeded)
                ...
                if self._dataValsArc.any():
                    print(f"{self._dataValsArc.get()},{self._dataValsPsi.get()}\r\n")
                else:
                    self._ser.write("--------------------\r\n")
                    self._ser.write("\r\n")
                    self._ser.write("+------------------------------------------------------------------------------+\r\n")
